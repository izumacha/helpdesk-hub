...
- `docs/` holds design artifacts (`requirements.html`, `architecture.html`, `er-diagram.html`, `screen-flow.html`; entry point: `docs/index.html`) — consult before changing status flow, permissions, or the ER model.
