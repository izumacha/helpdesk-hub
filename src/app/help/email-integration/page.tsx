      ...
      <section aria-labelledby="notes-heading">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          <ul className="ml-4 list-disc space-y-1">
            {/* 注意点 */}
            {/* §3.2 フォローアップ (2026-07-10): 「担当者が確認の上で処理する場合があります」という
                説明は、実装 (未登録送信者のメールはチケット化されず記録も残らない) と食い違っており、
                問い合わせが実際には届いていないのに「そのうち処理される」と誤解させていた。
                実態どおりに書き換える */}
            <li>
              組織内に登録済みのメールアドレスからのメールのみ自動でチケット化されます。
              未登録のアドレスから送られたメールはチケット化されず、記録も残りません。
