 ...
 *    共有すると、未認証で安く叩ける経路 (マジックリンクのコールバック 60 回/分・SSO ACS は
 *    テナント単位で `SSO_ACS_UNVERIFIED_TENANT_RATE_LIMIT` 回/分・全体で
 *    `SSO_UNAUTHENTICATED_RATE_LIMIT` 回/分。いずれも 1 種別あたりの予算より多い)
